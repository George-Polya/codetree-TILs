...
public class Main{
	static int n;
	static int board[][], idBoard[][],nxtBoard[][];
...
//		System.out.println("------");
		...
		for(int y=1; y<=n; y++) {
			System.arraycopy(nxtBoard[y], 1, board[y], 1, n);
		}
	}
